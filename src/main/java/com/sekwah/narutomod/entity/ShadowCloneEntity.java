...
public class ShadowCloneEntity extends Mob {

    private int aliveTicks = 20 * 3;

    public ShadowCloneEntity(EntityType<ShadowCloneEntity> p_21368_, Level p_21369_) {
    ...
    public ShadowCloneEntity(Level worldIn) {
        this(NarutoEntities.SHADOW_CLONE.get(), worldIn);
    }
